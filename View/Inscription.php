                ...
                <div class="col-sm-9">
                    ...
                    <form method="post" action="index.php" enctype="multipart/form-data">
                        <div class="container">
                            ...
                            <input type="password" placeholder="Entrez votre mot de passe" class="champ" name="mdp" required>

                            <label for="image"><b>Image de profil</b></label>
                            <input type="file" name="image" id="image" />

                            <button type="submit" class="submitinscription">Valider inscription</button>
                        </div>
                    </form>
                </div>
            </div>
